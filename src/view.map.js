    ...
    <form class="form-stacked"> \
      <div class="clearfix"> \
        ...
        <div class="editor-field-type-latlon"> \
          <label for="form-field-lat-field">{{t.Latitude_field}}</label> \
          ...
          <label for="form-field-lon-field">{{t.Longitude_field}}</label> \
        ...
        <div class="editor-field-type-geom" style="display:none"> \
          <label for="form-field-type-geom">{{t.map_mapping_geojson}}</label> \
